              ...
              <body>
                  <div class="container">
                      ...
                      <div class="reset-link">
                          <a href="http://localhost/Inner_Balance/Auth/reset_password.php?token='.urlencode($token).'">Reset Password</a>
                          <p>The link expires in 1 hour</p>
                      </div>
                      <footer>
                          <p>Best Regards,</p>
                          <p><strong>Astra Softwares</strong></p>
                          <p><a href="https://innerbalance.com">www.innerbalance.com</a></p>
